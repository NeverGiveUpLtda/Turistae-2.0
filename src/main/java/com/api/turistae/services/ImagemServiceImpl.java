...
public class ImagemServiceImpl implements ImagemService {
        ...
        @Override
        @Transactional
        public List<Long> postImagens(Long turismoId, List<ImagemDTO> dto) {
                ...
                for (ImagemDTO i : dto) {
                        ...
                        imagem.setDataCriacao(DataUtils.getDataAtualComMascara());
                        imagem.setDataEdicao(DataUtils.getDataAtualComMascara());
                        imagem.setString64(i.getString64());
                        imagem.setTurismo(turis);
                ...
                return imagemRepository.findAll().stream().map((Imagem i) -> DadosImagemDTO.builder()
                                ...
                                .turismo(TurismoDTO.builder()
                                                ...
                                                .cadastroNacionalPessoasJuridica(
                                                                i.getTurismo().getCadastroNacionalPessoasJuridica())
